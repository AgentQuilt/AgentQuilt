...
- land-gate — Pre-merge evidence gate: fresh output only, base merged before gates, review still binds (`codex-review` check), docs match the diff, non-destructive worktree cleanup. Fable-fired after codex-review PASS; dormant until code. [touched: 2026-08-24]
