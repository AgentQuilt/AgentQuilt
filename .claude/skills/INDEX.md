...
- self-curate — Record what the session learned in the vault memory zones (session log, decision log, open questions, cross-project memory), flag stale docs, file proposed factory changes as suggestions; edits no factory file. Triggers on "wrap up"/"save this"/settled decisions/journal at the AGENTS.md threshold (15). Headless model: Opus 5. [touched: 2026-08-24]
