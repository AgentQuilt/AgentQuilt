...
- curate-fold — Decide each open entry in `$V/90-meta/suggestions.md` (accept / reject / defer, one sentence, marked in place) and route accepted factory changes into a wave. Fires at the start of every wave, or at five open entries. [touched: 2026-08-25]
