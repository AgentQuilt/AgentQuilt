...
3. Frontmatter: `name`, `description` and `disable-model-invocation` per `.claude/rules/agent-files.md`; detail belongs in the body, which loads only on invocation. Done: `wc -w` on the description.
