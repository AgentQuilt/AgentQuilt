...
4. Acceptance criteria. Numbered, each pass/fail by a command or a read: "the gate works" fails the test; "three synthetic outputs return FAIL/FAIL/PASS" passes it. Done: every criterion names its evidence.
