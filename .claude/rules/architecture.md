...
- judgment-as-code: judgment in skills, execution in code. Code executes a decision already made; a heuristic decision tree in code belongs in a skill. Guarantees run the other way: authorization, tenant isolation, approval binding, idempotency and audit recording live in deterministic code, never in a skill.
